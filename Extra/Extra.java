...
/**
 * En la clase Extra, se abre el archivo de configuración, y se leen los parametros a utilizar en la simulación, 
...
public class Extra{
    public static void main(String [] args) throws IOException {
        ...
        s.nextLine();
        double R_time = s.nextDouble();
        double samplingTime = 1.0;  // 1 [s]
        Comuna comuna = new Comuna(comunaWidth, comunaLength);
        Simulador sim = new Simulador(System.out, comuna, Npeople, Iinfected, rec_Time, speed, deltaAngle, d, m, p0, p1, p2, numVac, vacsize, vactime, R_time);
