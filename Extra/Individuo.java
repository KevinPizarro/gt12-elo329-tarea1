...
public class Individuo {
    ...
    private double R_time; //Tiempo para volver a ser susceptible post-recuperarse
    private double Cont_Rtime; //Contador de tiempo para evaluar si vuelve a ser susceptible 
     ...
     */
    public Individuo (Comuna comuna, double speed, double deltaAngle, double R_time){
	//??
